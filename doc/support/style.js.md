...
**Selectors** - A list of currently supported css selectors - [List of css selectors - mdn web docs\_](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_selectors)
